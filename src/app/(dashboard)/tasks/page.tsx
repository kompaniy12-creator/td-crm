...
export default function TasksPage() {
  ...
  return (
    <div className="flex h-full flex-col">
      {/* Stats */}
      <div className="flex items-center gap-6 border-b border-white/15 bg-white/10 backdrop-blur-xl px-6 py-3 shadow-sm group-data-[theme=dark]/theme:bg-slate-900/15 group-data-[theme=dark]/theme:border-white/10 group-data-[theme=dark]/theme:text-gray-100">
      ...
      {/* Filters */}
      <div className="flex items-center gap-3 border-b border-white/15 bg-white/60 backdrop-blur-xl px-6 py-2 group-data-[theme=dark]/theme:bg-slate-900/50 group-data-[theme=dark]/theme:border-white/10 group-data-[theme=dark]/theme:text-gray-100">
