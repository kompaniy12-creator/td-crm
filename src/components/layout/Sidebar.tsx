      ...
      <div className={cn(
        ...
        <button
          ...
          className={cn(
            ...
            'group-data-[theme=dark]/theme:border-white/10 group-data-[theme=dark]/theme:bg-white/10 group-data-[theme=dark]/theme:text-gray-200 group-data-[theme=dark]/theme:hover:bg-white/20',
